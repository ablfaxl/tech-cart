...
import CategoryCard from './(category)/_components/card';
import ProductCard from './(product)/_components/cart';
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto py-16 px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
          <CategoryCard name="Clothing" image="/image/t-shirt-1.avif" />
          <CategoryCard name="Accessories" image="/image/cup-black.avif" />
          <CategoryCard name="Footwear" image="/image/t-shirt-1.avif" />
          <CategoryCard name="Home Goods" image="/image/cup-black.avif" />
        </div>
      </div>
